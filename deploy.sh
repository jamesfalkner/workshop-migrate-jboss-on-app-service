...
# Deploy WAR file
az storage blob upload --account-name $STORAGE_ACCOUNT -c $CONTAINER --overwrite -f ROOT.war
...
az storage blob upload --account-name $STORAGE_ACCOUNT -c $CONTAINER  --overwrite  -f setup/postgresql.jar
...
az storage blob upload --account-name $STORAGE_ACCOUNT -c $CONTAINER  --overwrite  -f setup/jboss-cli-commands.cli
...
az storage blob upload --account-name $STORAGE_ACCOUNT -c $CONTAINER  --overwrite  -f setup/startup.sh
